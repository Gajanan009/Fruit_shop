...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="SDfruits.php">'.$systemName.'</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            while($row = mysqli_fetch_assoc($result)){
              echo '<a class="dropdown-item" href="viewfruitList.php?catid=' .$row['categorieId']. '">' .$row['categorieName']. '</a>';
            }
            echo '</div>
          </li>
          <li class="nav-item">
        ...
        <form method="get" action="/OnlinefruitDelivery/search.php" class="form-inline my-2 my-lg-0 mx-3">
