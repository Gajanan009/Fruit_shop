  ...
  <?php include 'partials/_nav.php';?>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>FruitoPia</strong></h3>
            <h3><strong>The First Fastest Service in Fruit Delivery</strong></h3>
            <p class="font-italic">
          </div>
      ...
      <div class="container">
        ...
        <div class="row" style="padding-left: 228px;">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="box">
              <i style="position:relative;left:50px;top:-5px; font-size 60px"class="fas fa-6x"> &#xf007;</i></div><class="img-fluid" alt="">
              <div class="box-info">
                <div class="box-info-content">
                  <h4>Gajanan Khedkar</h4>
                  
                  <i style="position:relative;left:50px;top:30px; font-size 60px"class="fas fa-6x"> &#xf007;</i></div><class="img-fluid" alt="">
              <div class="box-info ">
                <div class="box-info-content">
                  <h4 style="margin-top: 1.67em;">Omkar khapare</h4>
                </div>
                </div>
              </div>
            </div>
